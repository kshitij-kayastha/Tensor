...
extern template class Tensor<unsigned int>;
extern template class Tensor<short int>;
extern template class Tensor<unsigned short int >;
extern template class Tensor<long int>;
extern template class Tensor<unsigned long int>;
extern template class Tensor<long long int>;
extern template class Tensor<unsigned long long int>;
...
extern template class Tensor<long double>;
